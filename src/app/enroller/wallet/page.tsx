    ...
    <div className="max-w-4xl mx-auto space-y-6">
        <Card>
            <CardHeader>
                ...
                <CardDescription>View your referral bonus earnings and request withdrawals.</CardDescription>
            </CardHeader>
            <CardContent>
                <Card className="bg-gradient-to-br from-green-500/10 to-accent/10">
                    <CardHeader className="p-4 pb-2">
                         <CardTitle className="text-sm font-medium">Available Bonus to Withdraw</CardTitle>
                    </CardHeader>
