...
export default function EnrollerBankDetailsPage() {
  ...
  const handleBankDetailsSubmit = async (values: z.infer<typeof bankSchema>) => {
    ...
    try {
      ...
      router.push('/enroller/wallet/withdraw');
    } catch (error) {
    ...
    <div>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage your bank account details and UPI ID for withdrawals.</CardDescription>
        </CardHeader>
